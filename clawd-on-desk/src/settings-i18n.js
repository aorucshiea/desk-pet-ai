...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      settingsSubtitle: "Configure how Desk Pet behaves on your desktop.",
      sidebarGeneral: "General",
      sidebarAgents: "Agents",
      sidebarTheme: "Theme",
      sidebarAnimMap: "Animation Map",
      sidebarAnimOverrides: "Animation & Sound Overrides",
      sidebarEmotion: "Emotion",
      sidebarProactive: "Autonomous Chat",
      ...
      telegramApprovalRecipientHintHtml: "Open [@userinfobot](https://t.me/userinfobot) in Telegram and send /start to get your numeric id. Desk Pet uses it both as the allowed approver and as the chat to send approval cards. Send /start to your own bot at least once first.",
      ...
      telegramApprovalDirectSendDesc: "When you reply to a Desk Pet completion notification, focus the matching local terminal and paste one line. It does not send Enter.",
      ...
      remoteSshSubtitle: "Manage one-click SSH tunnels for remote AI coding sessions. Profiles never store passwords or passphrases — Desk Pet relies on your existing ssh-agent / SSH keys.",
      ...
      remoteSshErrNoLocalPort: "Local Desk Pet server is not yet running.",
      remoteSshErrUnknownStrikes: "Multiple unrecognized errors in a row — please check the profile and logs.",
      remoteSshProbeLocalUnhealthy: "Tunnel established but local Desk Pet server is not healthy.",
      remoteSshProbeUnresponsive: "Tunnel established but Desk Pet is not responding. Make sure Desk Pet is running.",
      ...
      remoteSshConnectWarnNoDeploy: "Hooks are not deployed yet. Connect alone only builds the SSH tunnel — Desk Pet will not react to remote sessions until you click Deploy / Repair Hooks.",
      ...
      doctorPrivacy: "Privacy notice: this report is generated locally. Desk Pet does not upload data. User paths and secrets are redacted before copying.",
      ...
      doctorFixConfirmCodex: "Desk Pet will set [features].hooks = true in your Codex config. Continue?",
      doctorFixConfirmCodexTitle: "Enable Codex hooks?",
      doctorFixConfirmCodexDetail: "This repair will change your Codex config and set [features].hooks = true. Desk Pet will not make that change unless you confirm it here.",
      doctorFixConfirmCodexAction: "Enable and repair",
      doctorFixConfirmCancel: "Cancel",
      doctorRestartButton: "Restart Desk Pet",
      doctorRestarting: "Restarting",
      doctorRestartConfirmTitle: "Restart Desk Pet?",
      doctorRestartConfirmDetail: "Desk Pet will close and reopen. In-flight requests from your AI coding agents will be dropped. The Doctor window will close as part of the restart.",
      ...
      doctorConnectionNoActivityHint: "No agent hook traffic reached Desk Pet during the test. If you haven't enabled an agent yet, enable or install one in Settings, then send a message from that agent and run the test again.",
      ...
      hardwareBuddyQuickCommandsDesc: "Expose local preset buttons that create adapter-owned quick_command events. Desk Pet does not paste text or run shell commands.",
      ...
      hardwareBuddyTestErr_internal_error: "Hardware Buddy test failed inside Desk Pet.",
      ...
      agentIntegrationUninstallConfirm: "Uninstall this Desk Pet-managed integration? Only Desk Pet-managed hooks, plugins, or extensions will be removed.",
      ...
      agentInstallHintDesc: "Detected local signals for {agents}. Connect them to Desk Pet by installing Desk Pet-managed hooks, plugins, or extensions.",
      ...
      agentCleanupHintDesc: "Desk Pet is connected to {agents}, but no matching local installation was detected. Remove the Desk Pet-managed integration to stop startup sync and event entry for those agents.",
      agentCleanupHintRemove: "Remove integrations",
      agentCleanupHintDismiss: "Keep for now",
      rowAgentPermissions: "Show pop-up bubbles",
      rowAgentPermissionsDesc: "Turn off to let this agent handle prompts in its own terminal instead of showing a Desk Pet bubble.",
      ...
      rowCodexPermissionModeDesc: "Native keeps Codex AutoReview and terminal prompts in charge. Intercept shows Desk Pet Allow/Deny bubbles.",
      ...
      rowSoundDesc: "Play a chime when Desk Pet finishes a task or asks for input.",
      rowVolume: "Volume",
      rowVolumeDesc: "Adjust sound effect volume. Disabled when sound effects are off.",
      rowLowPowerIdleMode: "Low power idle",
      rowLowPowerIdleModeDesc: "Pause idle SVG animation after Desk Pet has been still for a few seconds; activity resumes animation immediately.",
      ...
      rowSessionCleanupGroupDesc: "How long Desk Pet waits before clearing inactive sessions. Mainly affects remote SSH sessions where the terminal isn't visible — raise the limit for long-running remote work, or set Session timeout to 0 to never clear by time.",
      ...
      rowOpenAtLoginDesc: "Start Desk Pet automatically when you log in.",
      ...
      claudeHooksDisconnectConfirmDetail: "This removes Desk Pet-managed Claude hooks from ~/.claude/settings.json and turns off automatic management. Start with Claude Code will be kept for later re-enable.",
      ...
      rowStartWithClaudeDesc: "Auto-launch Desk Pet whenever a Claude Code session starts.",
      ...
      rowHideBubblesDesc: "Hide permission, notification, and update bubbles across Desk Pet.",
      rowBubbleFollow: "Bubbles follow Desk Pet",
      ...
      autoApproveAllConfirmDetail: "Every permission request from every agent will be approved automatically, including running shell commands and deleting files. Desk Pet will not ask you first. Only enable this if you fully trust what your agents are doing.",
      ...
      updateBubbleDisableConfirmDetail: "You may miss update failures, download-complete messages, and restart prompts. The update flow itself will still run, but Desk Pet will not show update bubbles.",
      ...
      rowDisableMiniModeDesc: "Prevent Desk Pet from entering mini mode from edge snap or the menu",
      rowFreeRoam: "Free roam",
      rowFreeRoamDesc: "Let Desk Pet wander freely around the desk when idle. Movement stops when you move the mouse.",
      ...
      placeholderDesc: "This panel will land in a future Desk Pet release. The plan lives in docs/plans/plan-settings-panel.md.",
      ...
      langJapanese: "日本語",
      themeTitle: "Theme",
      themeSubtitle: "Pick a theme for Desk Pet. Cards show built-in + capability badges so you can see tracked/static/mini differences before switching.",
      ...
      themeImportUserThemeZip: "Import Desk Pet theme package (.zip)",
      themeImportUserThemeZipHint: "Desk Pet theme zip: root or one top-level folder must contain theme.json. Put SVG, GIF, APNG, PNG, WebP, JPG, or JPEG assets in assets/. Use Codex Pet import for Codex Pet packages.",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pets refreshed: ${imported} new, ${updated} updated, ${unchanged} unchanged, ${removed} removed${invalid ? `, ${invalid} invalid` : ""}${switched ? "; active theme reset to Desk Pet" : ""}.`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `Uninstalled "${name}"${switched ? " and switched back to Desk Pet" : ""}.`,
      toastCodexPetRemoveFailed: (message) => `Couldn't uninstall imported pet: ${message}`,
      animMapTitle: "Animation Map",
      animMapSubtitle: "Silence individual interrupt animations. Events still fire — Desk Pet just skips the visual and sound for the selected states.",
      ...
      aboutFooter: "Desk Pet is open source (AGPL-3.0).",
      aboutCleanupButton: "Remove Desk Pet integrations…",
      aboutCleanupConfirm: "Remove Desk Pet hooks/plugins from local agents and mark all agent integrations as uninstalled and disabled in Desk Pet? This does not delete agent apps or user configs.",
      ...
      screenclickTitle: "Screen Click",
      screenclickSubtitle: "Configure screen parsing and click functionality using OmniParser.",
      screenclickSectionGeneral: "General",
      screenclickSectionOcr: "OCR",
      screenclickEnabled: "Enable OmniParser",
      screenclickEnabledDesc: "Connect to OmniParser server for screen element detection.",
      screenclickClickEnabled: "Enable Click",
      screenclickClickEnabledDesc: "Allow the pet to click on screen elements it finds.",
      screenclickAlwaysAllow: "Always allow screen access",
      screenclickAlwaysAllowDesc: "Skip the per-action authorization dialog. Otherwise the pet asks (Allow / Deny) each time it wants to look at or operate the screen.",
      screenclickOcrMode: "OCR mode",
      screenclickOcrModeDesc: "Use local OCR (EasyOCR) or a remote OCR API.",
      screenclickOcrModeLocal: "Local (EasyOCR)",
      screenclickOcrModeApi: "API",
      screenclickChineseOcr: "Chinese OCR",
      screenclickChineseOcrDesc: "Include Chinese language model (requires restart).",
      screenclickOcrApiUrl: "OCR API URL",
      screenclickOcrApiUrlDesc: "Full URL of the OCR API endpoint.",
      screenclickOcrApiKey: "API Key",
      screenclickOcrApiKeyDesc: "Optional API key for the OCR service.",
      screenclickOcrApiModel: "OCR API model",
      screenclickOcrApiModelDesc: "Model name to use (e.g. gpt-4o-mini, qwen-vl-plus).",
    },
    zh: {
      settingsTitle: "设置",
      settingsSubtitle: "配置 Desk Pet 在桌面上的行为。",
      sidebarGeneral: "通用",
      ...
      telegramApprovalRecipientHintHtml: "去 Telegram 找 [@userinfobot](https://t.me/userinfobot) 私聊 /start 拿到你的数字 ID。Desk Pet 会用它既作为唯一可审批者，也作为接收审批卡的 chat。记得先去你自己的机器人发一条 /start 激活私聊。",
      ...
      telegramApprovalDirectSendDesc: "回复 Desk Pet 完成通知时，聚焦对应的本地终端并粘贴单行文本。不会按 Enter。",
      ...
      remoteSshSubtitle: "管理一键 SSH 隧道，让远程 AI 编码会话像本地一样工作。Desk Pet 不存任何密码或私钥口令——依赖你已配置的 ssh-agent / SSH 密钥。",
      ...
      remoteSshErrNoLocalPort: "本地 Desk Pet 服务尚未启动。",
      remoteSshErrUnknownStrikes: "连续多次未识别错误，请检查配置和日志。",
      remoteSshProbeLocalUnhealthy: "隧道已建立但本地 Desk Pet 服务异常。",
      remoteSshProbeUnresponsive: "隧道已建立但 Desk Pet 无响应，请确认 Desk Pet 在运行。",
      ...
      remoteSshConnectWarnNoDeploy: "Hook 文件还没部署。Connect 只建 SSH 隧道，不部署 hook——必须点 Deploy / Repair Hooks 之后 Desk Pet 才会响应远端会话。",
      ...
      doctorPrivacy: "隐私说明：诊断报告只在本机生成，Desk Pet 不会上传数据。复制前会脱敏用户路径和密钥。",
      ...
      doctorFixConfirmCodex: "Desk Pet 会把 Codex 配置里的 [features].hooks 设为 true。继续吗？",
      doctorFixConfirmCodexTitle: "启用 Codex hooks？",
      doctorFixConfirmCodexDetail: "这次修复会修改你的 Codex 配置，把 [features].hooks 设为 true。只有你在这里确认后，Desk Pet 才会做这个改动。",
      doctorFixConfirmCodexAction: "启用并修复",
      doctorFixConfirmCancel: "取消",
      doctorRestartButton: "重启 Desk Pet",
      doctorRestarting: "重启中",
      doctorRestartConfirmTitle: "重启 Desk Pet？",
      doctorRestartConfirmDetail: "Desk Pet 会关闭并重新启动。AI coding agent 正在进行的请求会被中断。重启过程中 Doctor 窗口也会一起关闭。",
      ...
      doctorConnectionNoActivityHint: "测试期间没有 agent 的 hook 流量到达 Desk Pet。如果你还没启用 agent，请先在设置里启用或安装一个，然后从该 agent 发一条消息，再重新测试。",
      ...
      hardwareBuddyQuickCommandsDesc: "显示本地 preset 按钮，只创建由 adapter 处理的 quick_command 事件；Desk Pet 不粘贴文本，也不运行 shell。",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      hardwareBuddyTestErr_internal_error: "Desk Pet 内部执行 Hardware Buddy 测试失败。",
      ...
      agentIntegrationUninstallConfirm: "要卸载这个由 Desk Pet 管理的集成吗？只会移除 Desk Pet 管理的 hooks、插件或扩展。",
      agentIntegrationInstallSkipped: "没有检测到本机安装了 {agents}，所以没有写入集成。",
      agentListSeparator: "、",
      agentInstallHintTitle: "连接检测到的 Agent",
      agentInstallHintDesc: "检测到本机可能有 {agents}。安装由 Desk Pet 管理的 hooks、插件或扩展后，它们就能驱动桌宠。",
      agentInstallHintInstallRecommended: "安装推荐项",
      agentInstallHintDismiss: "暂不处理",
      agentCleanupHintTitle: "检查缺失的本机 Agent",
      agentCleanupHintDesc: "Desk Pet 当前连接了 {agents}，但本机没有检测到对应安装。移除 Desk Pet 管理的集成后，会同时关闭这些 agent 的启动同步和事件入口。",
      agentCleanupHintRemove: "移除集成",
      agentCleanupHintDismiss: "先保留",
      rowAgentPermissions: "显示弹窗",
      rowAgentPermissionsDesc: "关闭后让该 agent 在自己的终端里处理提示，不再弹 Desk Pet 气泡。",
      rowAgentSubagentPermissions: "子 agent 权限弹窗",
      rowAgentSubagentPermissionsDesc: "关闭后，Task 子 agent 发起的权限请求不再弹 Desk Pet 气泡，改回终端处理。",
      rowCodexPermissionMode: "Codex 权限模式",
      rowCodexPermissionModeDesc: "Native 保持 Codex AutoReview 和终端原生提示接管；Intercept 显示 Desk Pet 允许/拒绝气泡。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      ...
      rowSoundDesc: "Desk Pet 完成任务或需要输入时播放提示音。",
      rowVolume: "音量",
      rowVolumeDesc: "调整音效音量。关闭音效时不可用。",
      rowLowPowerIdleMode: "低功耗 idle",
      rowLowPowerIdleModeDesc: "Desk Pet 静止几秒后暂停 idle SVG 动画；有活动时会立即恢复动画。",
      ...
      rowSessionCleanupGroupDesc: "Desk Pet 等待多久才清理不活跃会话。主要影响远程 SSH 会话（看不到终端窗口）——远程长任务可调大；设为 0 则永远不按时间清理。",
      ...
      rowOpenAtLogin: "开机自启",
      rowOpenAtLoginDesc: "登录系统时自动启动 Desk Pet。",
      ...
      claudeHooksDisconnectConfirmDetail: "这会从 `~/.claude/settings.json` 移除 Desk Pet 管理的 Claude hooks，并关闭自动管理。`随 Claude Code 启动` 的偏好会保留，方便以后重新启用。",
      claudeHooksDisconnectConfirmAction: "断开 hooks",
      claudeHooksDisconnectConfirmKeep: "继续保留",
      rowStartWithClaude: "随 Claude Code 启动",
      rowStartWithClaudeDesc: "Claude Code 会话开始时自动拉起 Desk Pet。",
      rowStartWithClaudeDisabledDesc: "需要先开启 Claude hooks 自动管理。关闭期间，端口变化和外部覆盖都不会被自动修补。",
      rowHideBubbles: "隐藏气泡",
      rowHideBubblesDesc: "隐藏 Desk Pet 的权限、通知和更新气泡。",
      rowBubbleFollow: "气泡跟随 Desk Pet",
      ...
      autoApproveAllConfirmDetail: "所有 agent 的每一个权限请求都会被自动通过，包括执行 shell 命令和删除文件。Desk Pet 不会再先问你。只有在你完全信任 agent 的行为时才开启。",
      ...
      updateBubbleDisableConfirmDetail: "隐藏后可能错过更新失败原因、下载完成提示和重启安装提示。更新流程本身仍会继续，但 Desk Pet 不再显示更新气泡。",
      ...
      placeholderDesc: "此面板将在 Desk Pet 后续版本中加入，规划见 docs/plans/plan-settings-panel.md。",
      ...
      langJapanese: "日本語",
      themeTitle: "主题",
      themeSubtitle: "为 Desk Pet 选择一个主题。卡片会显示内建和能力角标，切换前就能看出 tracked / static / mini 等差异。",
      themeEmpty: "没有可用的主题。",
      ...
      themeImportUserThemeZip: "导入 Desk Pet 主题包（.zip）",
      themeImportUserThemeZipHint: "Desk Pet 主题 zip：根目录或一个顶层文件夹内必须包含 theme.json；素材放在 assets/，可使用 SVG、GIF、APNG、PNG、WebP、JPG、JPEG。Codex Pet 包请用上方入口。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet 已刷新：新增 ${imported}，更新 ${updated}，未变 ${unchanged}，移除 ${removed}${invalid ? `，无效 ${invalid}` : ""}${switched ? "；当前主题已回退到 Desk Pet" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `已卸载 "${name}"${switched ? "，并切回 Desk Pet" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `卸载导入宠物失败：${message}`,
      animMapTitle: "动画映射",
      animMapSubtitle: "关掉不想看的打扰动画。事件照样会触发——Desk Pet 只是不再播放对应的动画和音效。",
      ...
      aboutFooter: "Desk Pet 为开源软件（AGPL-3.0）。",
      aboutCleanupButton: "移除 Desk Pet 集成…",
      aboutCleanupConfirm: "要移除本机各 agent 里的 Desk Pet hooks / plugins，并在 Desk Pet 里把所有 agent 集成标记为未安装且禁用吗？不会删除 agent 应用或用户配置。",
    ...
    "zh-TW": {
      settingsTitle: "設定",
      settingsSubtitle: "設定 Desk Pet 在桌面上怎麼動作。",
      sidebarGeneral: "一般",
      sidebarAgents: "Agent 管理",
      sidebarTheme: "主題",
      sidebarAnimMap: "動畫對應",
      ...
      telegramApprovalRecipientHintHtml: "到 Telegram 找 [@userinfobot](https://t.me/userinfobot) 私訊 /start 取得你的數字 ID。Desk Pet 會用它同時做為唯一核准者與接收核准卡片的 chat。記得先到你自己的機器人發一次 /start 啟動私訊。",
      telegramApprovalRecipientPlaceholder: "例如：123456789",
      ...
      telegramApprovalDirectSendDesc: "回覆 Desk Pet 完成通知時，聚焦對應的本機終端並貼上單行文字。不會按 Enter。",
      ...
      remoteSshSubtitle: "管理一鍵 SSH 通道，讓遠端 AI 程式設計工作階段像在本機一樣順手。Desk Pet 不會留下任何密碼或私鑰通行片語——靠你已經設好的 ssh-agent 或 SSH 金鑰。",
      ...
      remoteSshErrNoLocalPort: "本機 Desk Pet 服務尚未啟動。",
      remoteSshErrUnknownStrikes: "連續多次無法識別錯誤，請檢查設定和記錄檔。",
      remoteSshProbeLocalUnhealthy: "通道已建立，但本機 Desk Pet 服務狀態異常。",
      remoteSshProbeUnresponsive: "通道已建立，但 Desk Pet 沒有回應，請確認 Desk Pet 是否正在執行。",
      ...
      remoteSshHooksDeployedAgoDay: "{n} 天前部署",
      remoteSshConnectWarnNoDeploy: "Hook 檔案還沒部署。Connect 只接 SSH 通道、不會部署 hook——要先點 Deploy / Repair Hooks，Desk Pet 才會回應遠端工作階段。",
      ...
      doctorPrivacy: "隱私權聲明：診斷報告只在本機產生，Desk Pet 不會上傳任何資料。複製前會自動把使用者路徑和金鑰遮起來。",
      ...
      doctorFixConfirmCodex: "Desk Pet 會把 Codex 設定裡的 [features].hooks 改成 true。要繼續嗎？",
      doctorFixConfirmCodexTitle: "啟用 Codex hooks？",
      doctorFixConfirmCodexDetail: "這次修復會更動你的 Codex 設定，把 [features].hooks 改成 true。除非你在這裡確認，否則 Desk Pet 不會更動。",
      doctorFixConfirmCodexAction: "啟用並修復",
      doctorFixConfirmCancel: "取消",
      doctorRestartButton: "重新啟動 Desk Pet",
      doctorRestarting: "重新啟動中",
      doctorRestartConfirmTitle: "重新啟動 Desk Pet？",
      doctorRestartConfirmDetail: "Desk Pet 會關掉再開起來。AI coding agent 還在跑的請求會被中斷。重新啟動時 Doctor 視窗也會一起關掉。",
      ...
      doctorConnectionNoActivityHint: "測試期間沒有 agent 的 hook 流量到達 Desk Pet。如果你還沒啟用 agent，請先在設定裡啟用或安裝一個，然後從該 agent 發一則訊息，再重新測試。",
      ...
      hardwareBuddyQuickCommandsDesc: "顯示本機 preset 按鈕，只建立由 adapter 處理的 quick_command 事件；Desk Pet 不貼上文字，也不執行 shell。",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      agentIntegrationUninstallConfirm: "要解除安裝這個由 Desk Pet 管理的整合嗎？只會移除 Desk Pet 管理的 hooks、外掛或擴充功能。",
      agentIntegrationInstallSkipped: "沒有偵測到本機安裝了 {agents}，所以沒有寫入整合。",
      agentListSeparator: "、",
      agentInstallHintTitle: "連接偵測到的 Agent",
      agentInstallHintDesc: "偵測到本機可能有 {agents}。安裝由 Desk Pet 管理的 hooks、外掛或擴充功能後，它們就能驅動桌寵。",
      agentInstallHintInstallRecommended: "安裝推薦項",
      agentInstallHintDismiss: "暫不處理",
      agentCleanupHintTitle: "檢查缺失的本機 Agent",
      agentCleanupHintDesc: "Desk Pet 目前連接了 {agents}，但本機沒有偵測到對應安裝。移除 Desk Pet 管理的整合後，也會關閉這些 agent 的啟動同步與事件入口。",
      agentCleanupHintRemove: "移除整合",
      agentCleanupHintDismiss: "先保留",
      rowAgentPermissions: "顯示彈出視窗",
      rowAgentPermissionsDesc: "關掉以後，這個 agent 會改由自己的終端機處理提示，不會再彈 Desk Pet 對話框。",
      rowAgentSubagentPermissions: "子 agent 權限彈窗",
      rowAgentSubagentPermissionsDesc: "關掉以後，Task 子 agent 發起的權限請求不會再彈 Desk Pet 對話框，改回終端機處理。",
      rowCodexPermissionMode: "Codex 權限模式",
      rowCodexPermissionModeDesc: "Native 維持 Codex AutoReview 和終端機原本的提示；Intercept 改成顯示 Desk Pet 的允許或拒絕對話框。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      rowCodexNativeNotificationSound: "Native 通知音",
      ...
      rowSoundDesc: "Desk Pet 完成任務或要等輸入時會播放提示聲。",
      rowVolume: "音量",
      rowVolumeDesc: "調整音效音量。停用音效後無法使用。",
      rowLowPowerIdleMode: "低耗電閒置狀態",
      rowLowPowerIdleModeDesc: "Desk Pet 不動幾秒後就暫停閒置狀態 SVG 動畫；有活動時立即恢復。",
      ...
      rowSessionCleanupGroupDesc: "Desk Pet 等多久才清掉沒動靜的工作階段。主要影響遠端 SSH 工作階段（看不到終端機）——遠端長任務可以放寬；設成 0 就完全不按時間清。",
      ...
      rowOpenAtLoginDesc: "登入系統時自動啟動 Desk Pet。",
      ...
      claudeHooksDisconnectConfirmDetail: "這會從 `~/.claude/settings.json` 移除 Desk Pet 管的 Claude hooks，並關掉自動管理。「隨 Claude Code 啟動」的偏好會保留，方便之後再開啟。",
      claudeHooksDisconnectConfirmAction: "中斷 hooks 連線",
      claudeHooksDisconnectConfirmKeep: "繼續保留",
      rowStartWithClaude: "隨 Claude Code 啟動",
      rowStartWithClaudeDesc: "Claude Code 工作階段一開始就自動把 Desk Pet 叫起來。",
      rowStartWithClaudeDisabledDesc: "要先開啟 Claude hooks 自動管理。關掉的時候，連接埠變動和外部更動都不會自動修。",
      rowHideBubbles: "隱藏對話框",
      rowHideBubblesDesc: "隱藏 Desk Pet 的權限、通知和更新對話框。",
      rowBubbleFollow: "對話框跟著 Desk Pet",
      ...
      autoApproveAllConfirmDetail: "所有 agent 的每一個權限請求都會被自動允許，包括執行 shell 命令和刪除檔案。Desk Pet 不會再先問你。只有在你完全信任 agent 的行為時才開啟。",
      ...
      updateBubbleDisableConfirmDetail: "隱藏後可能會錯過更新失敗原因、下載完成提示和重新啟動安裝提示。更新流程本身還是會繼續，只是 Desk Pet 不再顯示更新對話框。",
      ...
      placeholderDesc: "這個面板會在 Desk Pet 後續版本加入，規劃見 docs/plans/plan-settings-panel.md。",
      ...
      langJapanese: "日本語",
      themeTitle: "主題",
      themeSubtitle: "幫 Desk Pet 選擇主題。主題卡會顯示是否為內建主題，以及游標跟隨、靜態、迷你模式等支援項目，方便切換前比較差異。",
      themeEmpty: "沒有主題可以用。",
      ...
      themeImportUserThemeZip: "匯入 Desk Pet 主題套件（.zip）",
      themeImportUserThemeZipHint: "Desk Pet 主題 zip：根目錄或單一頂層資料夾裡要有 theme.json；素材放在 assets/，支援 SVG、GIF、APNG、PNG、WebP、JPG、JPEG。Codex Pet 套件請改用上面的入口。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet 已重新整理：新增 ${imported}，更新 ${updated}，沒變 ${unchanged}，移除 ${removed}${invalid ? `，無效 ${invalid}` : ""}${switched ? "；目前主題已切回 Desk Pet" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `已解除安裝「${name}」${switched ? "，並切回 Desk Pet" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `解除安裝匯入的寵物失敗：${message}`,
      animMapTitle: "動畫對應",
      animMapSubtitle: "關掉不想看的打擾動畫。事件還是會觸發——Desk Pet 只是不再播對應的動畫和音效。",
      ...
      aboutFooter: "Desk Pet 為開源軟體（AGPL-3.0）。",
      screenclickTitle: "螢幕點擊",
      screenclickSubtitle: "設定螢幕解析和點擊功能，需要配合 OmniParser 使用。",
      screenclickSectionGeneral: "一般",
      screenclickSectionOcr: "文字識別",
      screenclickEnabled: "啟用 OmniParser",
      screenclickEnabledDesc: "連接到 OmniParser 服務進行螢幕元素偵測。",
      screenclickClickEnabled: "啟用點擊",
      screenclickClickEnabledDesc: "允許桌寵點擊螢幕上的元素。",
      screenclickAlwaysAllow: "總是允許查看螢幕",
      screenclickAlwaysAllowDesc: "跳過每次操作的授權詢問。關閉時，桌寵每次想看螢幕或操作螢幕都會彈授權（允許/拒絕）。",
      screenclickOcrMode: "OCR 模式",
      screenclickOcrModeDesc: "使用本地 OCR（EasyOCR）或遠端 OCR API。",
      screenclickOcrModeLocal: "本地（EasyOCR）",
      screenclickOcrModeApi: "API",
      screenclickChineseOcr: "中文識別",
      screenclickChineseOcrDesc: "啟用中文識別模型（需要重啟生效）。",
      screenclickOcrApiUrl: "OCR API 位址",
      screenclickOcrApiUrlDesc: "OCR API 的完整位址。",
      screenclickOcrApiKey: "API 金鑰",
      screenclickOcrApiKeyDesc: "OCR 服務的選用 API 金鑰。",
      screenclickOcrApiModel: "OCR API 模型",
      screenclickOcrApiModelDesc: "使用的模型名稱（如 gpt-4o-mini、qwen-vl-plus）。",
      aboutCleanupButton: "移除 Desk Pet 整合…",
      aboutCleanupConfirm: "要移除本機各 agent 內的 Desk Pet hooks / plugins，並在 Desk Pet 中將所有 agent 整合標記為未安裝且停用嗎？不會刪除 agent 應用程式或使用者設定。",
    ...
    ko: {
      ...
      telegramApprovalRecipientHintHtml: "Telegram에서 [@userinfobot](https://t.me/userinfobot)에게 /start를 보내 숫자 ID를 받으세요. Desk Pet는 이 ID를 승인 가능한 유일한 사용자이자 승인 카드 수신 chat으로 사용합니다. 본인의 bot에게도 먼저 /start를 한 번 보내 비공개 채팅을 활성화해야 합니다.",
      ...
      telegramApprovalDirectSend: "Direct Send (paste-only)",
      telegramApprovalDirectSendDesc: "Desk Pet 완료 알림에 답장하면 해당 로컬 터미널을 포커스하고 한 줄 텍스트를 붙여넣습니다. Enter는 누르지 않습니다.",
      ...
      remoteSshSubtitle: "원클릭 SSH 터널을 관리해 원격 AI 코딩 세션을 매끄럽게 사용하세요. Desk Pet는 비밀번호나 패스프레이즈를 저장하지 않으며, 기존 ssh-agent / SSH 키를 사용합니다.",
      ...
      remoteSshErrNoLocalPort: "로컬 Desk Pet 서버가 아직 시작되지 않았습니다.",
      remoteSshErrUnknownStrikes: "인식할 수 없는 오류가 연속 발생했습니다. 프로필과 로그를 확인하세요.",
      remoteSshProbeLocalUnhealthy: "터널은 연결되었지만 로컬 Desk Pet 서버가 비정상입니다.",
      remoteSshProbeUnresponsive: "터널은 연결되었지만 Desk Pet가 응답하지 않습니다. Desk Pet가 실행 중인지 확인하세요.",
      ...
      remoteSshConnectWarnNoDeploy: "Hook 파일이 아직 배포되지 않았습니다. Connect는 SSH 터널만 구축하므로, Deploy / Repair Hooks를 눌러야 원격 세션에 Desk Pet가 반응합니다.",
      ...
      doctorPrivacy: "개인정보 안내: 진단 보고서는 로컬에서 생성됩니다. Desk Pet는 데이터를 업로드하지 않으며 복사 전에 사용자 경로와 비밀값을 가립니다.",
      ...
      doctorFixConfirmCodex: "Desk Pet가 Codex 설정의 [features].hooks를 true로 변경합니다. 계속할까요?",
      doctorFixConfirmCodexTitle: "Codex hooks를 켤까요?",
      doctorFixConfirmCodexDetail: "이 복구는 Codex 설정의 [features].hooks를 true로 변경합니다. 여기에서 확인하기 전에는 Desk Pet가 이 변경을 하지 않습니다.",
      doctorFixConfirmCodexAction: "켜고 복구",
      doctorFixConfirmCancel: "취소",
      doctorRestartButton: "Desk Pet 재시작",
      doctorRestarting: "재시작 중",
      doctorRestartConfirmTitle: "Desk Pet를 재시작할까요?",
      doctorRestartConfirmDetail: "Desk Pet가 종료된 뒤 다시 실행됩니다. 진행 중인 AI 코딩 에이전트 요청은 중단됩니다. 재시작 중에는 Doctor 창도 함께 닫힙니다.",
      ...
      doctorConnectionNoActivityHint: "테스트 중에 에이전트의 hook 트래픽이 Desk Pet에 도달하지 않았습니다. 아직 에이전트를 활성화하지 않았다면 설정에서 활성화하거나 설치한 뒤, 해당 에이전트에서 메시지를 보내고 다시 테스트하세요.",
      ...
      hardwareBuddyQuickCommandsDesc: "로컬 preset 버튼을 표시해 adapter가 처리하는 quick_command 이벤트만 만듭니다. Desk Pet는 텍스트를 붙여넣거나 shell을 실행하지 않습니다.",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      agentIntegrationUninstallConfirm: "이 Desk Pet 관리 통합을 제거할까요? Desk Pet가 관리하는 hooks, 플러그인 또는 확장만 제거됩니다.",
      agentIntegrationInstallSkipped: "{agents}의 로컬 설치를 찾지 못해 통합을 쓰지 않았습니다.",
      agentListSeparator: ", ",
      agentInstallHintTitle: "감지된 에이전트 연결",
      agentInstallHintDesc: "{agents}에 대한 로컬 신호를 감지했습니다. Desk Pet 관리 hooks, 플러그인 또는 확장을 설치해 Desk Pet에 연결할 수 있습니다.",
      agentInstallHintInstallRecommended: "추천 항목 설치",
      agentInstallHintDismiss: "나중에",
      agentCleanupHintTitle: "누락된 로컬 에이전트 검토",
      agentCleanupHintDesc: "Desk Pet가 {agents}에 연결되어 있지만 일치하는 로컬 설치를 찾지 못했습니다. Desk Pet 관리 통합을 제거하면 해당 에이전트의 시작 동기화와 이벤트 입력도 꺼집니다.",
      agentCleanupHintRemove: "통합 제거",
      agentCleanupHintDismiss: "지금은 유지",
      rowAgentPermissions: "팝업 말풍선 표시",
      rowAgentPermissionsDesc: "끄면 이 에이전트는 Desk Pet 말풍선 대신 자체 터미널에서 프롬프트를 처리합니다.",
      rowAgentSubagentPermissions: "서브 에이전트 권한 말풍선",
      rowAgentSubagentPermissionsDesc: "끄면 Task 서브 에이전트의 권한 요청은 Desk Pet 말풍선 없이 터미널에서 처리됩니다.",
      rowCodexPermissionMode: "Codex 권한 모드",
      rowCodexPermissionModeDesc: "Native는 Codex AutoReview와 터미널 프롬프트를 그대로 사용합니다. Intercept는 Desk Pet 허용/거부 말풍선을 표시합니다.",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      ...
      rowSoundDesc: "Desk Pet가 작업을 마치거나 입력을 요청할 때 알림음을 재생합니다.",
      rowVolume: "볼륨",
      rowVolumeDesc: "효과음 볼륨을 조절합니다. 효과음이 꺼져 있을 때는 비활성화됩니다.",
      rowLowPowerIdleMode: "저전력 idle",
      rowLowPowerIdleModeDesc: "Desk Pet가 몇 초 동안 가만히 있으면 idle SVG 애니메이션을 일시 중지하고, 활동이 있으면 즉시 다시 재생합니다.",
      ...
      rowSessionCleanupGroupDesc: "Desk Pet가 비활성 세션을 얼마나 기다린 뒤 정리할지 설정합니다. 주로 터미널이 보이지 않는 원격 SSH 세션에 적용됩니다 — 장시간 원격 작업은 한도를 늘리거나, 세션 타임아웃을 0으로 두면 시간으로는 정리하지 않습니다.",
      ...
      rowOpenAtLoginDesc: "로그인할 때 Desk Pet를 자동으로 시작합니다.",
      ...
      claudeHooksDisconnectConfirmDetail: "`~/.claude/settings.json`에서 Desk Pet가 관리하는 Claude hooks를 제거하고 자동 관리를 끕니다. `Claude Code와 함께 시작` 설정은 나중에 다시 켤 수 있도록 유지됩니다.",
      ...
      rowStartWithClaudeDesc: "Claude Code 세션이 시작될 때마다 Desk Pet를 자동으로 실행합니다.",
      ...
      rowHideBubblesDesc: "Desk Pet의 권한, 알림, 업데이트 말풍선을 숨깁니다.",
      rowBubbleFollow: "말풍선이 Desk Pet를 따라다님",
      ...
      autoApproveAllConfirmDetail: "셸 명령 실행과 파일 삭제를 포함해 모든 에이전트의 모든 권한 요청이 자동으로 승인됩니다. Desk Pet가 먼저 묻지 않습니다. 에이전트의 동작을 완전히 신뢰할 때만 켜세요.",
      ...
      updateBubbleDisableConfirmDetail: "업데이트 실패 원인, 다운로드 완료 메시지, 재시작 안내를 놓칠 수 있습니다. 업데이트 흐름은 계속 실행되지만 Desk Pet는 업데이트 말풍선을 표시하지 않습니다.",
      ...
      rowFreeRoam: "자유 배회",
      rowFreeRoamDesc: "대기 중에 Desk Pet가 책상 위를 자유롭게 돌아다닙니다. 마우스를 움직이면 멈춥니다.",
      ...
      placeholderDesc: "이 패널은 향후 Desk Pet 릴리스에 추가됩니다. 계획은 docs/plans/plan-settings-panel.md에 있습니다.",
      ...
      langJapanese: "日本語",
      themeTitle: "테마",
      themeSubtitle: "Desk Pet의 테마를 선택합니다. 카드에는 기본 제공/능력 배지가 표시되어 tracked/static/mini 차이를 미리 볼 수 있습니다.",
      ...
      themeImportUserThemeZip: "Desk Pet 테마 패키지 가져오기 (.zip)",
      themeImportUserThemeZipHint: "Desk Pet 테마 zip: 루트 또는 하나의 최상위 폴더에 theme.json이 있어야 합니다. SVG, GIF, APNG, PNG, WebP, JPG, JPEG 파일은 assets/에 넣으세요. Codex Pet 패키지는 위의 가져오기를 사용하세요.",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet을 새로고침했습니다: 신규 ${imported}, 업데이트 ${updated}, 변경 없음 ${unchanged}, 제거 ${removed}${invalid ? `, 무효 ${invalid}` : ""}${switched ? "; 활성 테마를 Desk Pet로 되돌림" : ""}.`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `"${name}"을(를) 제거했습니다${switched ? " (Desk Pet로 전환됨)" : ""}.`,
      toastCodexPetRemoveFailed: (message) => `가져온 펫을 제거하지 못했습니다: ${message}`,
      animMapTitle: "애니메이션 맵",
      animMapSubtitle: "개별 인터럽트 애니메이션을 끕니다. 이벤트는 계속 발생하지만 Desk Pet는 선택한 상태의 화면과 소리만 건너뜁니다.",
      ...
      aboutFooter: "Desk Pet은 오픈 소스(AGPL-3.0)입니다.",
      screenclickTitle: "화면 클릭",
      screenclickSubtitle: "화면 분석 및 클릭 기능을 설정합니다. OmniParser와 함께 사용해야 합니다.",
      screenclickSectionGeneral: "일반",
      screenclickSectionOcr: "텍스트 인식",
      screenclickEnabled: "OmniParser 활성화",
      screenclickEnabledDesc: "OmniParser 서비스에 연결해 화면 요소를 감지합니다.",
      screenclickClickEnabled: "클릭 활성화",
      screenclickClickEnabledDesc: "펫이 화면의 요소를 클릭할 수 있도록 허용합니다.",
      screenclickAlwaysAllow: "화면 보기 항상 허용",
      screenclickAlwaysAllowDesc: "매번 작업 승인 요청을 건너뜁니다. 끄면 펫이 화면을 보거나 조작할 때마다 승인(허용/거부)을 묻습니다.",
      screenclickOcrMode: "OCR 모드",
      screenclickOcrModeDesc: "로컬 OCR(EasyOCR) 또는 원격 OCR API를 사용합니다.",
      screenclickOcrModeLocal: "로컬 (EasyOCR)",
      screenclickOcrModeApi: "API",
      screenclickChineseOcr: "중국어 인식",
      screenclickChineseOcrDesc: "중국어 인식 모델을 활성화합니다(재시작 필요).",
      screenclickOcrApiUrl: "OCR API 주소",
      screenclickOcrApiUrlDesc: "OCR API의 전체 주소입니다.",
      screenclickOcrApiKey: "API 키",
      screenclickOcrApiKeyDesc: "OCR 서비스의 선택적 API 키입니다.",
      screenclickOcrApiModel: "OCR API 모델",
      screenclickOcrApiModelDesc: "사용할 모델 이름(예: gpt-4o-mini, qwen-vl-plus).",
      aboutCleanupButton: "Desk Pet 통합 제거…",
      aboutCleanupConfirm: "로컬 에이전트의 Desk Pet hooks/plugins를 제거하고 Desk Pet의 모든 에이전트 통합을 미설치 및 비활성 상태로 표시할까요? 에이전트 앱이나 사용자 설정은 삭제하지 않습니다.",
    ...
    ja: {
      ...
      telegramApprovalRecipientHintHtml: "Telegram で [@userinfobot](https://t.me/userinfobot) に /start を送って数値 ID を取得します。Desk Pet はこの ID を唯一の承認者と承認カードを送る chat の両方として使います。事前に自分の bot にも /start を一度送ってプライベートチャットを有効にしてください。",
      ...
      telegramApprovalDirectSendDesc: "Desk Pet の完了通知に返信すると、対応するローカル端末をフォーカスして 1 行のテキストを貼り付けます。Enter は送信しません。",
      ...
      remoteSshSubtitle: "ワンクリック SSH トンネルを管理し、リモートの AI コーディングセッションをローカルのように扱えます。Desk Pet はパスワードやパスフレーズを保存せず、既存の ssh-agent / SSH キーを使います。",
      ...
      remoteSshErrNoLocalPort: "ローカル Desk Pet サーバーがまだ起動していません。",
      remoteSshErrUnknownStrikes: "認識できないエラーが連続して発生しました。プロフィールとログを確認してください。",
      remoteSshProbeLocalUnhealthy: "トンネルは確立しましたがローカル Desk Pet サーバーが異常です。",
      remoteSshProbeUnresponsive: "トンネルは確立しましたが Desk Pet が応答しません。Desk Pet が起動しているか確認してください。",
      ...
      remoteSshConnectWarnNoDeploy: "Hook ファイルがまだデプロイされていません。Connect は SSH トンネルを張るだけなので、Deploy / Repair Hooks を押さないとリモートセッションに Desk Pet が反応しません。",
      ...
      doctorPrivacy: "プライバシー: この診断レポートはローカルで生成されます。Desk Pet はデータをアップロードしません。コピー前にユーザーパスと秘密情報はマスクされます。",
      ...
      doctorFixConfirmCodex: "Desk Pet が Codex 設定の [features].hooks を true にします。続行しますか？",
      doctorFixConfirmCodexTitle: "Codex hooks を有効にしますか？",
      doctorFixConfirmCodexDetail: "この修復は Codex 設定を変更し、[features].hooks を true にします。ここで確認するまで、Desk Pet はこの変更を行いません。",
      doctorFixConfirmCodexAction: "有効化して修復",
      doctorFixConfirmCancel: "キャンセル",
      doctorRestartButton: "Desk Pet を再起動",
      doctorRestarting: "再起動中",
      doctorRestartConfirmTitle: "Desk Pet を再起動しますか？",
      doctorRestartConfirmDetail: "Desk Pet を終了して再起動します。進行中の AI coding agent リクエストは切断されます。再起動中は Doctor ウィンドウも閉じます。",
      ...
      doctorConnectionNoActivityHint: "テスト中にエージェントの hook トラフィックが Desk Pet に届きませんでした。まだエージェントを有効化していない場合は、設定で有効化またはインストールし、そのエージェントからメッセージを送ってから再度テストしてください。",
      ...
      hardwareBuddyQuickCommandsDesc: "ローカル preset ボタンを表示し、adapter が処理する quick_command イベントだけを作成します。Desk Pet は貼り付けや shell 実行をしません。",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      agentIntegrationUninstallConfirm: "この Desk Pet 管理の連携をアンインストールしますか？Desk Pet が管理する hooks、プラグイン、または拡張機能だけを削除します。",
      agentIntegrationInstallSkipped: "{agents} のローカルインストールが見つからなかったため、連携は書き込まれませんでした。",
      agentListSeparator: "、",
      agentInstallHintTitle: "検出したエージェントを接続",
      agentInstallHintDesc: "{agents} のローカル信号を検出しました。Desk Pet 管理の hooks、プラグイン、または拡張機能をインストールして Desk Pet に接続できます。",
      agentInstallHintInstallRecommended: "おすすめをインストール",
      agentInstallHintDismiss: "後で",
      agentCleanupHintTitle: "見つからないローカルエージェントを確認",
      agentCleanupHintDesc: "Desk Pet は {agents} に接続されていますが、一致するローカルインストールが検出されませんでした。Desk Pet 管理の連携を削除すると、それらのエージェントの起動時同期とイベント入口もオフになります。",
      agentCleanupHintRemove: "連携を削除",
      agentCleanupHintDismiss: "今は保持",
      rowAgentPermissions: "ポップアップ吹き出しを表示",
      rowAgentPermissionsDesc: "オフにすると、このエージェントは Desk Pet の吹き出しではなく自身のターミナル上でプロンプトを処理します。",
      rowAgentSubagentPermissions: "サブエージェントの権限吹き出し",
      rowAgentSubagentPermissionsDesc: "オフにすると、Task サブエージェントの権限リクエストは Desk Pet の吹き出しを表示せず、ターミナル側で処理されます。",
      rowCodexPermissionMode: "Codex 権限モード",
      rowCodexPermissionModeDesc: "Native は Codex AutoReview とターミナルの標準プロンプトに任せます。Intercept は Desk Pet の許可/拒否吹き出しを表示します。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      rowCodexNativeNotificationSound: "Native 通知音",
      ...
      rowSoundDesc: "Desk Pet がタスクを完了したとき、または入力を求めたときに音を再生します。",
      rowVolume: "音量",
      rowVolumeDesc: "効果音の音量を調整します。効果音オフの時は無効になります。",
      rowLowPowerIdleMode: "省電力アイドル",
      rowLowPowerIdleModeDesc: "数秒間 Desk Pet が静止していたら idle SVG アニメーションを停止し、活動が再開すると即座に復帰します。",
      ...
      rowSessionCleanupGroupDesc: "Desk Pet が非アクティブなセッションを整理するまでの待機時間。主にターミナルが見えないリモート SSH セッションに影響します — 長時間のリモート作業では制限を緩めるか、セッションタイムアウトを 0 にすると時間では整理しません。",
      ...
      rowOpenAtLoginDesc: "ログイン時に Desk Pet を自動起動します。",
      ...
      claudeHooksDisconnectConfirmDetail: "`~/.claude/settings.json` から Desk Pet 管理の Claude hooks を削除し、自動管理をオフにします。`Claude Code と同時に起動` 設定は後で再有効化できるよう保持されます。",
      claudeHooksDisconnectConfirmAction: "hooks を切断",
      claudeHooksDisconnectConfirmKeep: "接続を維持",
      rowStartWithClaude: "Claude Code と同時に起動",
      rowStartWithClaudeDesc: "Claude Code セッションが開始するたびに Desk Pet を自動起動します。",
      rowStartWithClaudeDisabledDesc: "Claude hooks の自動管理が必要です。管理がオフの間はポート変更や設定上書きが自動修復されません。",
      rowHideBubbles: "吹き出しを非表示",
      rowHideBubblesDesc: "Desk Pet の権限・通知・アップデート吹き出しをまとめて非表示にします。",
      rowBubbleFollow: "吹き出しが Desk Pet に追従",
      ...
      autoApproveAllConfirmDetail: "シェルコマンドの実行やファイルの削除を含め、すべてのエージェントのすべての権限リクエストが自動的に承認されます。Desk Pet は事前に確認しません。エージェントの動作を完全に信頼できる場合のみ有効にしてください。",
      ...
      updateBubbleDisableConfirmDetail: "アップデートエラーの原因・ダウンロード完了通知・再起動プロンプトを見逃す可能性があります。アップデート処理自体は継続しますが、Desk Pet は吹き出しを表示しません。",
      ...
      rowFreeRoam: "自由散策",
      rowFreeRoamDesc: "待機中にDesk Petがデスク上を自由に歩き回ります。マウスを動かすと停止します。",
      ...
      placeholderDesc: "このパネルは Desk Pet の今後のリリースで追加されます。計画は docs/plans/plan-settings-panel.md にあります。",
      ...
      langJapanese: "日本語",
      themeTitle: "テーマ",
      themeSubtitle: "Desk Pet のテーマを選びます。カードには組み込み・能力バッジが表示されるので、tracked / static / mini の違いを切替前に確認できます。",
      ...
      themeImportUserThemeZip: "Desk Pet テーマパッケージをインポート（.zip）",
      themeImportUserThemeZipHint: "Desk Pet テーマ zip: ルートまたは 1 つのトップフォルダに theme.json が必要です。SVG、GIF、APNG、PNG、WebP、JPG、JPEG は assets/ に入れてください。Codex Pet パッケージは上の入口を使います。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet を更新しました: 新規 ${imported}、更新 ${updated}、変更なし ${unchanged}、削除 ${removed}${invalid ? `、無効 ${invalid}` : ""}${switched ? "、使用中テーマを Desk Pet に戻しました" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `"${name}" をアンインストールしました${switched ? "。Desk Pet に戻しました" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `インポート済みペットをアンインストールできませんでした: ${message}`,
      animMapTitle: "アニメーションマップ",
      animMapSubtitle: "個別の割り込みアニメーションをオフにできます。イベント自体は発火しますが、Desk Pet は選択した状態の表示と効果音をスキップします。",
      ...
      aboutFooter: "Desk Pet はオープンソース（AGPL-3.0）です。",
      screenclickTitle: "画面クリック",
      screenclickSubtitle: "画面解析とクリック機能を設定します。OmniParser と併用します。",
      screenclickSectionGeneral: "一般",
      screenclickSectionOcr: "テキスト認識",
      screenclickEnabled: "OmniParser を有効化",
      screenclickEnabledDesc: "OmniParser サービスに接続して画面要素を検出します。",
      screenclickClickEnabled: "クリックを有効化",
      screenclickClickEnabledDesc: "ペットが画面上の要素をクリックすることを許可します。",
      screenclickAlwaysAllow: "画面表示を常に許可",
      screenclickAlwaysAllowDesc: "毎回の操作承認をスキップします。オフの場合、ペットが画面を見たり操作したりするたびに承認（許可/拒否）を求めます。",
      screenclickOcrMode: "OCR モード",
      screenclickOcrModeDesc: "ローカル OCR（EasyOCR）またはリモート OCR API を使用します。",
      screenclickOcrModeLocal: "ローカル（EasyOCR）",
      screenclickOcrModeApi: "API",
      screenclickChineseOcr: "中国語認識",
      screenclickChineseOcrDesc: "中国語認識モデルを有効化します（再起動が必要）。",
      screenclickOcrApiUrl: "OCR API アドレス",
      screenclickOcrApiUrlDesc: "OCR API の完全なアドレス。",
      screenclickOcrApiKey: "API キー",
      screenclickOcrApiKeyDesc: "OCR サービスの任意の API キー。",
      screenclickOcrApiModel: "OCR API モデル",
      screenclickOcrApiModelDesc: "使用するモデル名（例: gpt-4o-mini、qwen-vl-plus）。",
      aboutCleanupButton: "Desk Pet 連携を削除…",
      aboutCleanupConfirm: "ローカル agent から Desk Pet hooks/plugins を削除し、Desk Pet のすべての agent 連携を未インストールかつ無効としてマークしますか？agent アプリやユーザー設定は削除しません。",
  ...
  const MINICPM_PRODUCT_STRINGS = {
    en: {
      ...
      sidebarScreenClick: "Screen Click",
      sidebarProviders: "Providers",
      sidebarMcp: "MCP",
      sidebarEvolve: "Evolution",
      sidebarMemory: "Memory",
      sidebarHistory: "History",
      historyTitle: "Conversation History",
      historySubtitle: "What the pet said — last 24 hours",
      historyRefresh: "Refresh",
      historyEmpty: "No conversations in the last 24 hours.",
      historyNoTs: "Older messages have no timestamps — history collects from now on.",
      historyThinking: "💭 Thinking process",
      historyProactive: "⏰ Proactive wake-up",
      memoryTitle: "Memory",
      memorySubtitle: "What this pet (theme) remembers — identity notes, episodic events, and mood. Same self, continuously — only the look changes.",
      memoryLoading: "Loading memory…",
      memoryUnreachable: "Cannot reach the sidecar.",
      memoryTheme: "Theme",
      memoryMood: "Mood",
      memoryEventCount: "Events",
      memoryIdentity: "Identity notes",
      memoryEvents: "Episodic memories",
      memoryEmpty: "(empty)",
      memoryNoEvents: "No events yet — this body is still new.",
      memoryKnowledge: "knowledge",
      memoryUnfinished: "unfinished",
      memoryCore: "core",

      langSystem: "System",
      aboutTitle: "About Desk Pet",
      aboutSubtitle: "A local desktop pet for AI coding.",
      aboutTagline: "A local-first desktop pet for your AI coding workflow.",
      aboutFooter: "Desk Pet is open source (AGPL-3.0).",
      minicpmTitle: "Model",
      minicpmSubtitle: "Configure your local model.",
      minicpmIpcUnavailable: "IPC unavailable (preload not loaded).",
      minicpmSectionBehavior: "Behavior",
      minicpmSectionModel: "Model",
      minicpmSectionEngine: "Engine",
      minicpmRowEngineVersion: "Engine version",
      minicpmEngineSectionDesc: "Update the llama.cpp inference engine (llama-server). The engine restarts for a few seconds.",
      minicpmEngineUnchecked: "Not checked yet",
      minicpmEngineCheckButton: "Check version",
      minicpmEngineCheckBusy: "Checking…",
      minicpmEngineUnreachable: "Sidecar unreachable",
      minicpmEngineUpdateAvailable: "New version {remote} available (local build {local})",
      minicpmEngineUpToDate: "Already latest (build {local})",
      minicpmEngineUpdateButton: "Update engine",
      minicpmEngineUpdateBusy: "Updating…",
      minicpmEngineUpdateDone: "Engine updated & restarted",
      minicpmEngineUpdateFailed: "Engine update failed: ",
      minicpmEngineUpdateDirButton: "Update from folder…",
      minicpmEngineUpdateDirVerifying: "Verifying engine folder…",
      ...
      minicpmModelPickerLabel: "Available local models",
      minicpmModelPickerDesc: "Switch to a different .gguf on disk without going through a file picker.",
      minicpmPickModelButton: "Switch to this model",
      minicpmPickModelBusy: "Loading model...",
      minicpmNoAdditionalModels: "Only your default model is available. Drop a .gguf in your userData/models folder to add more.",
      minicpmOpenModelsFolder: "Open models folder",
      minicpmModelsFolderAdd: "Add model folder...",
      minicpmModelsFolderAdded: "Added",
      minicpmModelsFolderAddFailed: "Couldn't add folder: ",
      minicpmModelsFolderRemove: "Remove",
      minicpmModelsFolderLabel: "Scanned model folders",
      minicpmModelsFolderEmpty: "No folders added yet",
      minicpmModelsFolderHint: "Folder: {path}",
      minicpmModelsFolderOpenFailed: "Couldn't open the models folder: ",
    ...
    zh: {
      ...
      sidebarMinicpm: "MiniCPM",
      sidebarSkills: "技能系统",
      sidebarProviders: "模型供应",
      sidebarScreenClick: "屏幕点击",
      sidebarMcp: "MCP",
      sidebarEvolve: "自我进化",
      sidebarMemory: "记忆",
      sidebarHistory: "历史",
      historyTitle: "对话历史",
      historySubtitle: "桌宠说了什么——最近 24 小时",
      historyRefresh: "刷新",
      historyEmpty: "最近 24 小时还没有对话。",
      historyNoTs: "更早的记录没有时间戳——历史从现在开始收集。",
      historyThinking: "💭 思考过程",
      historyProactive: "⏰ 主动唤醒",
      memoryTitle: "记忆",
      memorySubtitle: "这个桌宠（主题）记得的东西——身份笔记、事件记忆、情绪。同一个我持续存在，换的只是形象。",
      memoryLoading: "正在读取记忆…",
      memoryUnreachable: "无法连接引擎服务。",
      memoryTheme: "主题",
      memoryMood: "情绪",
      memoryEventCount: "事件数",
      memoryIdentity: "身份记忆",
      memoryEvents: "事件记忆",
      memoryEmpty: "（空）",
      memoryNoEvents: "还没有任何事件——这个身体还太新。",
      memoryKnowledge: "知识",
      memoryUnfinished: "未完成",
      memoryCore: "核心",
      langSystem: "跟随系统",
      aboutTitle: "关于 Desk Pet",
      aboutSubtitle: "本地 AI 桌宠。",
      aboutTagline: "本地优先的 AI 编码桌宠伙伴。",
      aboutFooter: "Desk Pet 为开源软件（AGPL-3.0）。",
      minicpmTitle: "模型",
      minicpmSubtitle: "配置你的本地模型。",
      minicpmSectionBehavior: "行为",
      minicpmSectionModel: "模型",
      minicpmSectionEngine: "推理引擎",
      minicpmRowEngineVersion: "引擎版本",
      minicpmEngineSectionDesc: "更新 llama.cpp 推理引擎（llama-server）。引擎会短暂重启几秒。",
      minicpmEngineUnchecked: "尚未检查",
      minicpmEngineCheckButton: "检查版本",
      minicpmEngineCheckBusy: "检查中…",
      minicpmEngineUnreachable: "无法连接引擎服务",
      minicpmEngineUpdateAvailable: "有新版本 {remote}（本地 build {local}）",
      minicpmEngineUpToDate: "已是最新（build {local}）",
      minicpmEngineUpdateButton: "更新引擎",
      minicpmEngineUpdateBusy: "更新中…",
      minicpmEngineUpdateDone: "引擎已更新并重启",
      minicpmEngineUpdateFailed: "引擎更新失败：",
      minicpmEngineUpdateDirButton: "从文件夹更新…",
      minicpmEngineUpdateDirVerifying: "正在校验引擎文件夹…",
      ...
      minicpmModelPickerLabel: "可用的本地模型",
      minicpmModelPickerDesc: "在不打开文件选择器的情况下，直接切换硬盘上其它 .gguf 模型。",
      minicpmPickModelButton: "切换到此模型",
      minicpmPickModelBusy: "正在加载模型...",
      minicpmModelsFolderAdd: "添加模型文件夹...",
      minicpmModelsFolderAdded: "已添加",
      minicpmModelsFolderAddFailed: "无法添加文件夹：",
      minicpmModelsFolderRemove: "移除",
      minicpmModelsFolderLabel: "扫描的模型文件夹",
      minicpmModelsFolderEmpty: "还没添加任何文件夹",
      minicpmNoAdditionalModels: "把 .gguf 文件放到任意一个已添加的文件夹里，下拉就会自动出现。",
      ...
      screenclickTitle: "屏幕点击",
      screenclickSubtitle: "配置屏幕解析和点击功能，需要配合 OmniParser 使用。",
      screenclickSectionGeneral: "通用",
      screenclickSectionOcr: "文字识别",
      screenclickEnabled: "启用 OmniParser",
      screenclickEnabledDesc: "连接到 OmniParser 服务进行屏幕元素检测。",
      screenclickClickEnabled: "启用点击",
      screenclickClickEnabledDesc: "允许桌宠点击屏幕上的元素。",
      screenclickAlwaysAllow: "总是允许查看屏幕",
      screenclickAlwaysAllowDesc: "跳过每次操作的授权询问。关闭时，桌宠每次想看屏幕或操作屏幕都会弹授权（允许/拒绝）。",
      screenclickOcrMode: "OCR 模式",
      screenclickOcrModeDesc: "使用本地 OCR（EasyOCR）或远程 OCR API。",
      screenclickOcrModeLocal: "本地（EasyOCR）",
      screenclickOcrModeApi: "API",
      screenclickChineseOcr: "中文识别",
      screenclickChineseOcrDesc: "启用中文识别模型（需要重启生效）。",
      screenclickOcrApiUrl: "OCR API 地址",
      screenclickOcrApiUrlDesc: "OCR API 的完整地址。",
      screenclickOcrApiKey: "API 密钥",
      screenclickOcrApiKeyDesc: "OCR 服务的可选 API 密钥。",
      screenclickOcrApiModel: "OCR API 模型",
      screenclickOcrApiModelDesc: "使用的模型名称（如 gpt-4o-mini、qwen-vl-plus）。",
    },
    "zh-TW": {
      settingsSubtitle: "設定 MiniCPM 桌寵在桌面上怎麼動作。",
      sidebarMinicpm: "MiniCPM",
      sidebarSkills: "技能系統",
      sidebarProviders: "模型供應",
      ...
      sidebarHistory: "歷史",
      historyTitle: "對話歷史",
      historySubtitle: "桌寵說了什麼——最近 24 小時",
      historyRefresh: "重新整理",
      historyEmpty: "最近 24 小時還沒有對話。",
      historyNoTs: "更早的紀錄沒有時間戳——歷史從現在開始收集。",
      historyThinking: "💭 思考過程",
      historyProactive: "⏰ 主動喚醒",
      langSystem: "跟隨系統",
      aboutTitle: "關於 Desk Pet",
      aboutSubtitle: "本地 MiniCPM 驅動的 AI 桌寵。",
      aboutTagline: "本地 MiniCPM 驅動的 AI 程式設計桌寵夥伴。",
      aboutFooter: "Desk Pet 為開源軟體（AGPL-3.0）。",
      memoryTitle: "記憶",
      memorySubtitle: "這個桌寵（主題）記得的東西——身分筆記、事件記憶、情緒。同一個我持續存在，換的只是形象。",
      memoryLoading: "正在讀取記憶…",
      memoryUnreachable: "無法連接引擎服務。",
      memoryTheme: "主題",
      memoryMood: "情緒",
      memoryEventCount: "事件數",
      memoryIdentity: "身分記憶",
      memoryEvents: "事件記憶",
      memoryEmpty: "（空）",
      memoryNoEvents: "還沒有任何事件——這個身體還太新。",
      memoryKnowledge: "知識",
      memoryUnfinished: "未完成",
      memoryCore: "核心",
    },
    ko: {
      ...
      sidebarHistory: "기록",
      historyTitle: "대화 기록",
      historySubtitle: "펫이 한 말 — 최근 24시간",
      historyRefresh: "새로고침",
      historyEmpty: "최근 24시간 동안 대화가 없습니다.",
      historyNoTs: "이전 기록에는 타임스탬프가 없습니다 — 지금부터 수집됩니다.",
      historyThinking: "💭 생각 과정",
      historyProactive: "⏰ 능동적 호출",
      langSystem: "시스템",
      aboutTitle: "Desk Pet 정보",
      aboutSubtitle: "로컬 MiniCPM 기반 AI 데스크톱 펫.",
      aboutTagline: "로컬 MiniCPM으로 동작하는 AI 코딩 데스크톱 펫.",
      aboutFooter: "Desk Pet은 오픈 소스(AGPL-3.0)입니다.",
      memoryTitle: "기억",
      memorySubtitle: "이 펫(테마)이 기억하는 것 — 정체성 노트, 사건 기억, 감정. 같은 자아가 계속 존재하며, 바뀌는 것은 모습뿐입니다.",
      memoryLoading: "기억을 불러오는 중…",
      memoryUnreachable: "엔진 서비스에 연결할 수 없습니다.",
      memoryTheme: "테마",
      memoryMood: "감정",
      memoryEventCount: "사건 수",
      memoryIdentity: "정체성 기억",
      memoryEvents: "사건 기억",
      memoryEmpty: "(비어 있음)",
      memoryNoEvents: "아직 사건이 없습니다 — 이 몸은 아직 새롭습니다.",
      memoryKnowledge: "지식",
      memoryUnfinished: "미완료",
      memoryCore: "핵심",
    },
    ja: {
      settingsSubtitle: "Desk Pet のデスクトップでの動作を設定します。",
      ...
      sidebarHistory: "履歴",
      historyTitle: "会話履歴",
      historySubtitle: "ペットの発言 — 直近24時間",
      historyRefresh: "更新",
      historyEmpty: "直近24時間の会話はありません。",
      historyNoTs: "以前の記録にタイムスタンプはありません — 今から収集します。",
      historyThinking: "💭 思考プロセス",
      historyProactive: "⏰ 自発的な呼び出し",
      langSystem: "システム",
      aboutTitle: "Desk Pet について",
      aboutSubtitle: "ローカル MiniCPM 駆動の AI デスクトップペット。",
      aboutTagline: "ローカル MiniCPM で動く AI コーディング用デスクトップペット。",
      aboutFooter: "Desk Pet はオープンソース（AGPL-3.0）です。",
      memoryTitle: "記憶",
      memorySubtitle: "このペット（テーマ）が覚えているもの — アイデンティティノート、出来事の記憶、感情。同じ存在が続いており、変わるのは見た目だけ。",
      memoryLoading: "記憶を読み込み中…",
      memoryUnreachable: "エンジンサービスに接続できません。",
      memoryTheme: "テーマ",
      memoryMood: "気分",
      memoryEventCount: "出来事数",
      memoryIdentity: "アイデンティティ記憶",
      memoryEvents: "出来事の記憶",
      memoryEmpty: "（空）",
      memoryNoEvents: "まだ何もありません — この体はまだ新しい。",
      memoryKnowledge: "知識",
      memoryUnfinished: "未完了",
      memoryCore: "コア",
    },
  };
