...
(function initSettingsI18n(root) {
  ...
  const MINICPM_PRODUCT_STRINGS = {
    en: {
      ...
      memoryTitle: "Memory",
      memorySubtitle: "What this pet (theme) remembers — identity notes, episodic events, and mood. 换身体 = 换灵魂.",
    ...
    zh: {
      ...
      sidebarMemory: "记忆",
      memoryTitle: "记忆",
      memorySubtitle: "这个桌宠（主题）记得的东西——身份笔记、事件记忆、情绪。换身体 = 换灵魂。",
    ...
    "zh-TW": {
      ...
      aboutFooter: "Desk Pet 為開源軟體（AGPL-3.0）。",
      memoryTitle: "記憶",
      memorySubtitle: "這個桌寵（主題）記得的東西——身分筆記、事件記憶、情緒。換身體 = 換靈魂。",
    ...
    ko: {
      ...
      aboutFooter: "Desk Pet은 오픈 소스(AGPL-3.0)입니다.",
      memoryTitle: "기억",
      memorySubtitle: "이 펫(테마)이 기억하는 것 — 정체성 노트, 사건 기억, 감정. 몸을 바꾸면 영혼도 바뀝니다.",
    ...
    ja: {
      ...
      aboutFooter: "Desk Pet はオープンソース（AGPL-3.0）です。",
      memoryTitle: "記憶",
      memorySubtitle: "このペット（テーマ）が覚えているもの — アイデンティティノート、出来事の記憶、感情。体を変えれば魂も変わる。",
