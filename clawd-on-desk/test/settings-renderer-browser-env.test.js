...
describe("settings renderer browser environment", () => {
  ...
  it("groups Theme cards and exposes theme import actions in Settings", () => {
    ...
    assert.strictEqual(strings.en.themeImportUserThemeZip, "Import Desk Pet theme package (.zip)");
    ...
    assert.strictEqual(strings.zh.themeImportUserThemeZip, "导入 Desk Pet 主题包（.zip）");
